    ...
    <div id="main-container">
        ...
        <div id="main-content">
            ...
            <div style="margin:auto;">
                <script type="text/javascript">
                    atOptions = {
                        'key': 'ec3868a490039dd4bd2ff5445e6028c6',
                        'format': 'iframe',
                        'height': 90,
                        'width': 728,
                        'params': {}
                    ...
                    document.write('<scr' +
                        'ipt type="text/javascript" src="//www.topcreativeformat.com/ec3868a490039dd4bd2ff5445e6028c6/invoke.js"></scr' +
                        'ipt>');
                </script>
            </div>
        </div>
        ...
        <div id="right-section">
            <div id="banner">
                <script type="text/javascript">
                    atOptions = {
                        'key': '692b7cddb20efdff973c42942f1fa09b',
                        'format': 'iframe',
                        'height': 600,
                        'width': 160,
                        'params': {}
                    ...
                    document.write('<scr' +
                        'ipt type="text/javascript" src="//www.topcreativeformat.com/692b7cddb20efdff973c42942f1fa09b/invoke.js"></scr' +
                        'ipt>');
                </script>
            </div>
        </div>
